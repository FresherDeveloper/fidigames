...
//
//     final gameListDetail = gameListDetailFromJson(jsonString);

import 'dart:convert';

GameListModel gameListDetailFromJson(String str) => GameListModel.fromJson(json.decode(str));
...
class GameListModel {
    ...
    factory GameListModel.fromJson(Map<String, dynamic> json) => GameListModel(
        ...
        data: List<GameDetail>.from(json["data"].map((x) => GameDetail.fromJson(x))),
    );
