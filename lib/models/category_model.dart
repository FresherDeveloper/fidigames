...
List<GameCategoryModel> gameCategoryModelFromJson(String str) => List<GameCategoryModel>.from(json.decode(str).map((x) => GameCategoryModel.fromJson(x)));

String gameCategoryModelToJson(List<GameCategoryModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
